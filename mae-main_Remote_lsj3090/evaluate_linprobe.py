...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./output_dir/Sampler-12000/ratio_1-11/finetune_sampler_all/w-cls-Blr-1.5e-3-Resize-toTensor-Adam-pretrain/checkpoint-99.pth',
...
def main(args):
    ...
    print(f"Accuracy of the network on the val_dataset {len(dataset_val)} test images: {val_stats['acc1']:.1f}%")
