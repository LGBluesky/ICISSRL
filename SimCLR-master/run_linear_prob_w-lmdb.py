...
def main(args):
    ...
    train_dataset = dataset.get_dataset(args.dataset_name, args.n_views, to_train=True,lmdb_path=args.lmdb_dir)
    ...
    val_dataset = dataset.get_dataset(args.dataset_name, args.n_views, to_train=False, lmdb_path=args.lmdb_dir)
